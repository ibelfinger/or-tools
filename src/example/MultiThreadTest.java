...
public class MultiThreadTest {
  ...
  private final static class SolverThread implements Callable<ResultStatus> {

    private ResultStatus statusSolver;
    ...
    public ResultStatus call() throws Exception {
      ...
      if ( ResultStatus.OPTIMAL.equals(statusSolver) ) {
    ...
    public ResultStatus getStatusSolver() {
      return statusSolver;
    }
